...
void main() => runApp(MaterialApp(home: CyberLawQuizPage()));

class CyberLawQuizPage extends StatefulWidget {
  @override
  _QuizPageState createState() => _QuizPageState();
}

class _QuizPageState extends State<CyberLawQuizPage> {
  ...
  void _checkQuizProgress() async {
    ...
    if (user != null) {
      ...
      bool hasAttempted = await service.getQuizProgress('attemptBusinessQuiz2');
      if (hasAttempted) {
        int previousScore = await service.getQuizScore('businessQuiz2Score');
  ...
  void _submitQuiz() async {
    ...
    if (user != null) {
      ...
      if (score > previousScore) {
        ...
        service.updateQuizScore('businessQuiz2Score', score);
        service.updateQuizProgress('attemptBusinessQuiz2', true);
      }
    }
